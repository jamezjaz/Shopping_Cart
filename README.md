...
<p align="center">
  ...
  <p align="center">
    This is an e-commerce application. It's a shopping cart application built with React &amp; Redux. Here, users can add and remove items from the cart.
    <br />
...
* Clone this repo:
  - Clone with SSH:
  ```
    git@github.com:jamezjaz/Shopping_Cart.git
  ```
...
Feel free to check the [issues page](https://github.com/jamezjaz/Shopping_Cart/issues).
